            ...
            return ueggEmbEstudianteEmbarazo
              .update({
                ...
                id_pcpa_unidad_educativa:
                  req.body.id_pcpa_unidad_educativa ??
                  ueggEmbEstudianteEmbarazo.id_pcpa_unidad_educativa,

                id_emb_informe_embarazo:
                  req.body.id_emb_informe_embarazo ??
                  ueggEmbEstudianteEmbarazo.id_emb_informe_embarazo,

                // Datos personales
                cod_rude: req.body.cod_rude ?? ueggEmbEstudianteEmbarazo.cod_rude,
                cedula_identidad:
                  req.body.cedula_identidad ??
                  ueggEmbEstudianteEmbarazo.cedula_identidad,
                complemento:
                  req.body.complemento ??
                  ueggEmbEstudianteEmbarazo.complemento,
                fec_nacimiento:
                  req.body.fec_nacimiento ??
                  ueggEmbEstudianteEmbarazo.fec_nacimiento,

                nombres_estudiante:
                  req.body.nombres_estudiante ??
                  ueggEmbEstudianteEmbarazo.nombres_estudiante,
                apellido_pat_estudiante:
                  req.body.apellido_pat_estudiante ??
                  ueggEmbEstudianteEmbarazo.apellido_pat_estudiante,
                apellido_mat_estudiante:
                  req.body.apellido_mat_estudiante ??
                  ueggEmbEstudianteEmbarazo.apellido_mat_estudiante,
                ...
                // Discapacidad
                check_estudiante_discapacidad:
                  req.body.check_estudiante_discapacidad ??   ueggEmbEstudianteEmbarazo.check_estudiante_discapacidad,
                ...
                // Unión temprana
                check_estudiante_conviviente:
                  req.body.check_estudiante_conviviente ??   ueggEmbEstudianteEmbarazo.check_estudiante_conviviente,

                // Auditoría
                estado: req.body.estado ?? ueggEmbEstudianteEmbarazo.estado,
                usu_mod: req.body.usu_mod ?? ueggEmbEstudianteEmbarazo.usu_mod,
                fec_mod: req.body.fec_mod ?? ueggEmbEstudianteEmbarazo.fec_mod,
              })
              .then(() => {
